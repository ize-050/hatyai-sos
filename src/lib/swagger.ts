// OpenAPI Specification - Hardcoded for production compatibility
export const getApiDocs = () => {
  return {
    ...
    info: {
      ...
      version: '1.0.0',
      description: `## ศูนย์ช่วยเหลือน้ำท่วมหาดใหญ่ - API Documentation
...
- รองรับ JSON format`,
    ...
    tags: [
      { name: 'SOS', description: 'รายการขอความช่วยเหลือ' },
      { name: 'Shelters', description: 'ศูนย์อพยพและจุดช่วยเหลือ' },
      { name: 'Updates', description: 'ข่าวสารและประกาศ' },
    ],
    paths: {
      '/api/sos': {
        get: {
          ...
          parameters: [
            ...
            },
            {
              name: 'help_type',
              in: 'query',
              schema: { type: 'string', enum: ['food', 'medical', 'evacuation', 'boat'] },
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      data: { type: 'array', items: { $ref: '#/components/schemas/SOSRequest' } },
                      count: { type: 'integer' },
                    },
                  },
                },
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  required: ['phone', 'help_type', 'severity', 'latitude', 'longitude'],
                  properties: {
                    name: { type: 'string', description: 'ชื่อผู้ขอความช่วยเหลือ' },
                    phone: { type: 'string', description: 'เบอร์โทรศัพท์' },
                    help_type: { type: 'string', enum: ['food', 'medical', 'evacuation', 'boat'] },
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean' },
                      data: { type: 'array', items: { $ref: '#/components/schemas/EvacuationCenter' } },
                      count: { type: 'integer' },
                    },
                  },
                },
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    has_toilet: { type: 'boolean' },
                    has_shower: { type: 'boolean' },
                    has_bedding: { type: 'boolean' },
          ...
          parameters: [
            {
              name: 'type',
              in: 'query',
              schema: { type: 'string', enum: ['info', 'warning', 'success'] },
